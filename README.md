# Ana Machado Semijoias - Análise de Vendas

O projeto foi desenvolvido por mim como simulação de uma empresa fictícia de semijoias, **Ana Machado**, com o objetivo de praticar **Power BI** em um cenário completo de análise de dados.
